...
VALUES
    ((SELECT product_id FROM products WHERE title = 'iPhone 15 Pro Max 256GB' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=1', true, 1),
    ((SELECT product_id FROM products WHERE title = 'iPhone 15 Pro Max 256GB' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=2', false, 2);
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'MacBook Air M2 13-inch' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=3', true, 1),
    ((SELECT product_id FROM products WHERE title = 'MacBook Air M2 13-inch' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=4', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Sofa Minimalis 2 Seater' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=5', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Sofa Minimalis 2 Seater' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=6', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Sepatu Nike Air Jordan 1' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=7', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Sepatu Nike Air Jordan 1' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=8', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Kamera Canon EOS R50' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=9', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Kamera Canon EOS R50' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=10', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Meja Belajar Kayu Jati' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=11', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Meja Belajar Kayu Jati' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=12', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Tas Gucci Marmont Mini' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=13', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Tas Gucci Marmont Mini' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=14', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Samsung Galaxy S23 Ultra' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=15', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Samsung Galaxy S23 Ultra' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=16', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Lemari Pakaian 3 Pintu' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=17', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Lemari Pakaian 3 Pintu' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=18', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Jam Tangan Rolex Submariner' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=19', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Jam Tangan Rolex Submariner' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=20', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'iPad Pro 12.9-inch M2' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=21', true, 1),
    ((SELECT product_id FROM products WHERE title = 'iPad Pro 12.9-inch M2' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=22', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Kursi Ergonomis Kantor' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=23', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Kursi Ergonomis Kantor' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=24', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Dompet Kulit Pria Louis Vuitton' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=25', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Dompet Kulit Pria Louis Vuitton' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=26', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Laptop Dell XPS 13' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=27', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Laptop Dell XPS 13' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=28', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Rak Buku Minimalis' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=29', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Rak Buku Minimalis' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=30', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Kacamata Ray-Ban Original' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=31', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Kacamata Ray-Ban Original' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=32', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Headphone Sony WH-1000XM5' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=33', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Headphone Sony WH-1000XM5' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=34', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Meja Makan Kayu Jati' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=35', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Meja Makan Kayu Jati' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=36', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Sepatu Adidas Ultraboost' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=37', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Sepatu Adidas Ultraboost' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=38', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
...
INSERT INTO productimages (product_id, image_url, is_primary, order_sequence)
VALUES
    ((SELECT product_id FROM products WHERE title = 'Drone DJI Mini 3 Pro' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=39', true, 1),
    ((SELECT product_id FROM products WHERE title = 'Drone DJI Mini 3 Pro' ORDER BY product_id DESC LIMIT 1), 'https://picsum.photos/600/400?image=40', false, 2);
INSERT INTO productspecs (product_id, category_product_spec_id, spec_value)
VALUES
